...
OGLRenderer::OGLRenderer(Window& w) : RendererBase(w)	{
	...
	debugTextMesh->SetVertexPositions(std::vector<Vector3>(50000, Vector3()));
	debugTextMesh->SetVertexColours(std::vector<Vector4>(50000, Vector3()));
	debugTextMesh->SetVertexTextureCoords(std::vector<Vector2>(50000, Vector3()));
